...
public:
    ...
    bool isArrayFunction() const { return _isArray; }
    bool &setFunction() { return _isArray; }
    bool isFuntionCall() const { return _isFunction; }
    bool &setFunctionCall() { return _isFunction; }
